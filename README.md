...
```
cd existing_repo
git remote add origin https://gitlab.com/uplift-code-camp/students/batch-17/online-library-jam.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/uplift-code-camp/students/batch-17/online-library-jam/-/settings/integrations)
